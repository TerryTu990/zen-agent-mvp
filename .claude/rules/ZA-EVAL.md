...
**改 `assets/`（system-prompt 基座 / pack.json / feature.md / facts.md / tools.json / skills）后 MUST 跑功能配置评测集，全绿才算改对；评测维度闭集：讲解正确 / 装配换出 / 引导命中 / 工具触发 / HITL 触发。**
- 站点功能陈述的事实边界并入「讲解正确」维度判据。
