...
代码版本：commit `efbf456`；工作区 **有未提交改动（dirty）**。
证据环境：评测输入 SHA-256 `089a0ceb93ea5335bad3e54124526c7ca1adcc6ab90e907a5f1807ad379ecf68`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
