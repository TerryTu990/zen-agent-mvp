...
代码版本：commit `ad686c7`；工作区 **有未提交改动（dirty）**。
证据环境：评测输入 SHA-256 `e3a9deb3f819c8d46e6d2a8b8245a6b824aedabb207543f1e5fcce27c1219313`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
