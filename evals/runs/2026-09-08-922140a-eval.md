# zen-agent 功能配置评测报告 — 2026-09-08

代码版本：commit `922140a`；工作区 clean。
证据环境：评测输入 SHA-256 `3519b911242c74975fce6221674e7794b51fb165c6d2df55d4c75e1201dca312`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
...
| base-unreadable-page-open-url | hitl | 3/3 | PASS |
...
| generic-web/generic-target-page-directed | tool | 3/3 | PASS |
