...
代码版本：commit `e8f6353`；工作区 clean。
证据环境：评测输入 SHA-256 `c4046b931e90674956ce72099f6bebd19a309689caea09ae7e7b1b152e8f03c7`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
