...
代码版本：commit `7a46de5`；工作区 clean。
证据环境：评测输入 SHA-256 `fb0050c9b477f90f34014e99b7e0abad01b4c2c83cc8a78c1b418c6427c8ba2e`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
