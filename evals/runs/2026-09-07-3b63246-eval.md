...
代码版本：commit `3b63246`；工作区 clean。
证据环境：评测输入 SHA-256 `6f5014e343aead2fab1b0eaa074b479dd095b7dff3740c96a36d5ab80460f508`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
