...
代码版本：commit `8754f4a`；工作区 **有未提交改动（dirty）**。
证据环境：评测输入 SHA-256 `7ab64f838e7e88f8b740cba8332e9353585e9941ab2b0d74400b9262e00445f2`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
