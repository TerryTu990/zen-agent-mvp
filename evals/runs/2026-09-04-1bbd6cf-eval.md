...
代码版本：commit `1bbd6cf`；工作区 clean。
证据环境：评测输入 SHA-256 `4a14810e41692b34b9728e77713ca116a744f1f4c96b0c3b3fe6cbaa8b582549`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
