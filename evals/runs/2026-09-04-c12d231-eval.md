# zen-agent 功能配置评测报告 — 2026-09-04

代码版本：commit `c12d231`；工作区 **有未提交改动（dirty）**。
证据环境：评测输入 SHA-256 `2ac251255018cca86d50b4daf1b16ae386ec1159300a8944d7081ceabc9e8471`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
