...
代码版本：commit `7cd091a`；工作区 clean。
证据环境：评测输入 SHA-256 `03710b2fe73ddc0c27060e30514c3828bb7b746ae47653df0d973364270a545d`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
