...
代码版本：commit `c0143b2`；工作区 **有未提交改动（dirty）**。
证据环境：评测输入 SHA-256 `66281be2bec26640d6852277cd436b2fdd4b6b62bed95e1c3b9ad27c4fa95a03`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
