...
代码版本：commit `84460eb`；工作区 clean。
证据环境：评测输入 SHA-256 `2b5dd8611602d71e720766d245934eb7395da8d9e9f5257b556880310d2cd160`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
