...
代码版本：commit `24df066`；工作区 clean。
证据环境：评测输入 SHA-256 `1ea6c2e5fd0e006d15569a467d9fb2095052720feb121c749d02962d2f939421`（覆盖 evals/scenarios.json 与四个快照根 examples/host-demo/config、examples/acceptance、assets、examples/site-packs）；Node `>=22`；`pnpm@10.32.1`。
